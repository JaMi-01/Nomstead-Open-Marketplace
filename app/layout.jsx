      ...
      <body className="bg-gradient-to-b from-white to-[#fdf6e3] min-h-screen text-gray-800">
        <header className="bg-white shadow-sm py-6">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-center italic text-sm text-gray-600 mt-1">Version 3.1</p>
          </div>
        </header>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm text-sm text-gray-600">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
              <div className="space-y-0">
                ...
                <div>
                  <strong>Vision by:</strong>{' '}
                  <a className="text-blue-600 underline" href="https://x.com/jamionfire?s=21" target="_blank" rel="noreferrer">JaMi</a>
                </div>
              </div>
              <div className="space-y-0">
                <div><strong>Build on:</strong>{' '}
                  <a className="text-blue-600 underline" href="https://github.com/JaMi-01/Nomstead-Open-Marketplace" target="_blank" rel="noreferrer">GitHub</a>
                </div>
        ...
        <footer className="max-w-6xl mx-auto px-4 mt-8 mb-10 text-center text-xs text-gray-500">
          <div>Nomstead Open Marketplace • v3.1</div>
        </footer>
      </body>
    </html>
  );
