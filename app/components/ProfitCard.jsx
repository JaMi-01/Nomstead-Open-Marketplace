  ...
  return (
    <div className="bg-gradient-to-r from-sky-50 to-white rounded-lg p-4 shadow-sm card-hover border border-sky-200">
      <div className="flex gap-3 items-center">
        <div className="flex-shrink-0 flex items-center justify-center w-[60px] h-[60px]">
          <img
          ...
          <div className="mt-2 text-sm space-y-2">
            <div>
              ...
              <span className="font-medium">
                {Number(buy.unitPrice).toFixed(4)} gold
              </span>{' '}
              Qty: {buy.quantity}
            </div>
            ...
            <div>
              ...
              @{' '}
              <span className="font-medium">
                {Number(sell.unitPrice).toFixed(4)} gold
              </span>{' '}
              Qty: {sell.quantity}
            </div>
