...
export default function DonateSnippet() {
  ...
  return (
    <div className="bg-gradient-to-r from-white to-yellow-50 p-4 rounded-lg shadow-sm mb-6 max-w-3xl mx-auto text-center">
      <p className="font-semibold text-gray-800 mb-1">Support the project here:</p>
      <p className="text-sm text-gray-700 mb-1">
        ETH or USDC<br />
        on Ethereum, Polygon, Arbitrum or Immutable zkEVM.
      </p>
      <p className="text-sm text-gray-700 break-all mb-3">
